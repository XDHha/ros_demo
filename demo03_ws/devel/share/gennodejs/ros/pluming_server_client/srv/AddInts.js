...
// (in-package pluming_server_client.srv)
...
class AddIntsRequest {
  ...
  static datatype() {
    ...
    return 'pluming_server_client/AddIntsRequest';
  }
...
class AddIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'pluming_server_client/AddIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'pluming_server_client/AddInts'; }
};
